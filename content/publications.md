...
1. **Prophet Secretary and Matching: the Significance of the Largest Item**  
   ...
   *SODA 2025*  
   [arXiv](https://arxiv.org/abs/2411.01191) · [SODA25](./files/SODA25_Prophet_Secretary_and_Matching_the_Significance_of_the_Largest_Item.pdf)

1. **Automating approximation analysis for Nash equilibria algorithms in two-player games**  
...
1. **On the Optimal Mixing Problem of Approximate Nash Equilibria in Bimatrix Games**  
   Authors: Xiaotie Deng, Dongchen Li, Hanyu Li  
   *IJTCS 2024; TCS 2025 (extended version)*  
   [IJTCS24](./files/IJTCS24_On the Optimal Mixing Problem.pdf) · [TCS25](./files/TCS25_On_the_Optimal_Mixing_Problem.pdf)
