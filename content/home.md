...
- Lecture notes (in Chinese) for undergraduate courses:  
  [Lecture Note on Reinforcement Learning and Prediction Theory, 强化学习与预测论讲义](./files/强化学习与预测论讲义.pdf),  
  [Lecture Note on Nash Equilibrium and Computational Complexity, 纳什均衡与计算复杂性讲义](./files/纳什均衡与计算复杂性.pdf)

---

## Awards & Honors {#awards}

- **Best Paper Award** — [IJTCS 2024](https://ijtcs2024.comp.polyu.edu.hk/accepted.html), Track C: Computational Economics and Algorithmic Game Theory  
- **Presidential PhD Scholarship** — The University of Hong Kong (2023–present)  
